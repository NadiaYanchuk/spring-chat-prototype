...
**Этап 1** (сентябрь-декабрь 2025): Базовая структура, WebSocket, фронтенд на Thymeleaf
**Этап 2** (январь-май 2026): Полная система безопасности, CRUD, логирование, управление ролями
